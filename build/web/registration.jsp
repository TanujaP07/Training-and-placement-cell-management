...
<body data-spy="scroll" data-target="#navbar-example" style="background-image:url(img/slider/slider1.jpg)">
		...
		<div class="container-login100" >
			<div class="wrap-login100 p-t-30 p-b-50">
					...
					REGISTER
                            ...
                            <form class="login100-form validate-form p-b-33 p-t-5" action="registeract.jsp" method="post">

					<div class="wrap-input100 validate-input" >
                                            <input class="input100" type="text" name="username" placeholder="User Name" required="" >
						<span class="focus-input100" placeholder="&#xe82a;">User Name:</span>
					</div>
					...
					<div class="wrap-input100 " >
                                            <input class="input100" type="date" name="dob" placeholder="DOB" required="" >
						<span class="focus-input100" >DOB:</span>
					</div>
						...
						<span class="focus-input100" placeholder="&#xe82a;">Mobile:</span>
					</div>
