			...
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					View Data
                            ...
                            <form class="login100-form validate-form p-b-33 p-t-5" action="viewact.jsp" method="post">

					<div class="wrap-input100 validate-input" data-validate = "Enter username">
                                            <input class="input100" type="text" name="bpercentage" placeholder="Btech Percentage" required="">
						<span class="focus-input100" placeholder="&#xe82a;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Enter password">
                                            <input class="input100" type="text" name="backlogs" placeholder="Backlogs" required="">
						<span class="focus-input100" data-placeholder="&#xe80f;"></span>
					</div>
                                        <div class="wrap-input100 " >
						<input class="input100" type="text" name="ipercentage" placeholder="Inter Percentage">
						<span class="focus-input100" placeholder="&#xe82a;"></span>
					</div>

					<div class="wrap-input100 " >
						<input class="input100" type="text" name="tpercentage" placeholder="Tenth Percentage">
